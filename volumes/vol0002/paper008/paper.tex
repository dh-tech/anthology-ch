...
\begin{figure}[t!]
  \centering
  \includegraphics[width=0.45\linewidth]{figures/open_research_data_template.png}
  \includegraphics[width=0.45\linewidth]{figures/open_research_data_template_new_repo.png} \\
  \includegraphics[width=0.45\linewidth]{figures/open_research_data_template_codespace.png}
  \includegraphics[width=0.45\linewidth]{figures/open_research_data_template_readme.png}
...
\begin{figure}[t!]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/decoding_inequality_2025.png}
